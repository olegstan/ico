				...
				<?php foreach($matches as $i => $item) : ?>
					...
					<tr class="iedit<?php if($i % 2 == 0) echo ' alternate'; ?>">
						...
						<td class="game_title column-game_title">
							<?php echo isset($item->game_icon) ? wp_get_attachment_image($item->game_icon, array(32,32)) : ''; ?>
						...
						<td class="team1 column-team1">
							<?php echo isset($item->team1_logo) ? wp_get_attachment_image($item->team1_logo, array(32,32)) : ''; ?>
							<?php esc_html_e($item->team1_title); ?>
						</td>
						<td class="team2 column-team2">
							<?php echo isset($item->team2_logo) ? wp_get_attachment_image($item->team2_logo, array(32,32)) : ''; ?>
