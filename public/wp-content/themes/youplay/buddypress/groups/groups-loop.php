...
<?php if ( bp_has_groups( bp_ajax_querystring( 'groups' ) ) ) : ?>
	...
	<table id="groups-list" class="item-list table table-hover">
		...
		<tr <?php bp_group_class(); ?>>
			<?php if ( ! bp_disable_group_avatar_uploads() ) : ?>
				<td class="item-avatar p-15" width="130">
					<a href="<?php bp_group_permalink(); ?>" class="angled-img">
						<div class="img">
			...
			<td class="item p-15">
				...
				<div class="item-meta"><span class="date"><?php printf( __( 'active %s', 'youplay' ), bp_get_group_last_active() ); ?></span></div>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'There were no groups found.', 'youplay' ); ?></p>
	</div>
