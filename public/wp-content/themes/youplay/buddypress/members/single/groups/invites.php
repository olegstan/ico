	...
	<ul id="group-list" class="invites item-list">
		...
		<?php while ( bp_groups() ) : bp_the_group(); ?>
			...
			<li>
				...
				<h4><a href="<?php bp_group_permalink(); ?>"><?php bp_group_name(); ?></a><span class="small"> - <?php printf( _nx( '%d member', '%d members', bp_get_group_total_members( false ),'Group member count', 'youplay' ), bp_get_group_total_members( false )  ); ?></span></h4>
				...
				<div class="action">
					<a class="button accept" href="<?php bp_group_accept_invite_link(); ?>"><?php _e( 'Accept', 'youplay' ); ?></a> &nbsp;
					<a class="button reject confirm" href="<?php bp_group_reject_invite_link(); ?>"><?php _e( 'Reject', 'youplay' ); ?></a>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'You have no outstanding group invites.', 'youplay' ); ?></p>
	</div>
