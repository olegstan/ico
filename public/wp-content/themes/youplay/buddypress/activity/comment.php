...
<li id="acomment-<?php bp_activity_comment_id(); ?>">
	<article class="comment-body">
	    ...
	    <a class="comment-avatar pull-left" href="<?php bp_activity_comment_user_link(); ?>">
	    ...
	    <div class="comment-cont clearfix">
	        ...
	        <span class="pull-right">
				<?php if ( is_user_logged_in() && bp_activity_can_comment_reply( bp_activity_current_comment() ) ) : ?>
					...
					<a href="#acomment-<?php bp_activity_comment_id(); ?>" class="acomment-reply bp-primary-action" id="acomment-reply-<?php bp_activity_id(); ?>-from-<?php bp_activity_comment_id(); ?>"><?php _e( 'Reply', 'youplay' ); ?></a>

				<?php endif; ?>

				<?php if ( bp_activity_user_can_delete() ) : ?>

					<a href="<?php bp_activity_comment_delete_link(); ?>" class="delete acomment-delete confirm bp-secondary-action" rel="nofollow"><?php _e( 'Delete', 'youplay' ); ?></a>
            ...
            <div class="comment-author h4"><a href="<?php echo bp_get_activity_comment_user_link(); ?>"><?php echo bp_get_activity_comment_name(); ?></a></div>

	        <div class="date">
				<?php
				/* translators: 1: user profile link, 2: user name, 3: activity permalink, 4: activity timestamp */
				printf( __( 'replied <a href="%1$s" class="activity-time-since"><span class="time-since">%2$s</span></a>', 'youplay' ), bp_get_activity_comment_permalink(), bp_get_activity_comment_date_recorded() );
				?>
	        </div>
