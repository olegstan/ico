	...
	<div class="col-2">
		...
		<form method="post">
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
				...
				<div class="youplay-input">
					<input type="text" class="input-text" name="username" id="reg_username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( $_POST['username'] ) : ''; ?>" />
				</div>
			...
			<span class="btn btn-default">
				<?php esc_html_e( 'Register', 'youplay' ); ?>
				<input type="submit" class="button" name="register" value="<?php esc_attr_e( 'Register', 'youplay' ); ?>" />
			</span>
