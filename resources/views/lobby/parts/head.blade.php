...
<style>.file-input-wrapper {
    ...
    .youplay-checkbox.wpcf7-youplay-checkbox input[type=checkbox] + label:after {
        left: 0;
    }

    .youplay-radio.wpcf7-youplay-radio input[type=radio] + label:after {
        left: 0;
    }

    .youplay-checkbox.wpcf7-youplay-checkbox input[type=checkbox] + label:before {
        left: 4px;
    }

    .youplay-radio.wpcf7-youplay-radio input[type=radio] + label:before {
        left: 7px;
    }
    ...
    .youplay-input.has-error:after, .youplay-textarea.has-error:after {
...
<style id="youplay-style-wp-inline-css" type="text/css">
    ...
    /* Custom Background */
    body {
        background-image: url(https://wp.nkdev.info/youplay/wp-content/themes/youplay/assets/images/background.jpg);
...
<style type="text/css" data-type="vc_shortcodes-custom-css">.vc_custom_1515053762226 {
        background-color: rgba(129, 215, 66, 0.38) !important;
        *background-color: rgb(129, 215, 66) !important;
    }

    .vc_custom_1515350488636 {
        background-color: rgba(30, 115, 190, 0.53) !important;
...
<style>.youplay-carousel-0 .owl-item {
        padding-left: 10px;
        padding-right: 10px;
    }</style>
