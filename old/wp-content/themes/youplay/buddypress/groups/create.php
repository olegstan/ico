			...
			<?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
				...
				<div class="submit" id="previous-next">
					...
					<?php if ( !bp_is_first_group_creation_step() ) : ?>
						...
						<button type="button" id="group-creation-previous" name="previous" onclick="location.href='<?php bp_group_creation_previous_link(); ?>'" class="btn btn-default"><?php esc_html_e( 'Back to Previous Step', 'youplay' ); ?></button>
					...
					<?php if ( !bp_is_last_group_creation_step() && !bp_is_first_group_creation_step() ) : ?>
						...
						<button type="submit" id="group-creation-next" name="save" class="btn btn-default"><?php esc_html_e( 'Next Step', 'youplay' ); ?></button>
					...
					<?php if ( bp_is_first_group_creation_step() ) : ?>
						...
						<button type="submit" id="group-creation-create" name="save" class="btn btn-default"><?php esc_html_e( 'Create Group and Continue', 'youplay' ); ?></button>
					...
					<?php if ( bp_is_last_group_creation_step() ) : ?>
						...
						<button type="submit" id="group-creation-finish" name="save" class="btn btn-default"><?php esc_html_e( 'Finish', 'youplay' ); ?></button>
