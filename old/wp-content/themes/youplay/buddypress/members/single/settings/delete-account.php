...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/delete-account'; ?>" name="account-delete-form" id="account-delete-form" class="standard-form" method="post">
	...
	<div class="submit">
		<button type="submit" disabled="disabled" id="delete-account-button" name="delete-account-button" class="btn btn-default"><?php esc_html_e( 'Delete Account', 'youplay' ); ?></button>
	</div>
